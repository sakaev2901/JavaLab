package com.example.demo.consumer.app3;
...
public class FirePdfGenerator {
    ...
    public void generate(UserDto userDto) {
        ...
        PdfWriter writer = new PdfWriter("C:\\Users\\LDAR\\Desktop\\LRNG\\3 курс\\JavaLab\\1. PDF CONSUMER\\fire\\F-" + userDto.getFullName().replace(" ", "-") +
                UUID.randomUUID() + ".pdf");
        ...
        document.add(new Paragraph("Прошу Вас, меня "+userDto.getFullName()+" "+userDto.getBirthday()
                ...
                userDto.getAge() + " лет"+ ")"+" уволить по причине низкой зарплаты"));
        document.add(new Paragraph());
        document.add(new Paragraph());
